  ...
  resources: {
    ...
    fa: {
      translation: {
        ...
        current_decade: 'دههٔ جاری',
        next_month: 'ماه بعد',
        next_year: 'سال بعد',
        next_decade: 'دههٔ بعد',
        previous_month: 'ماه قبل',
        previous_year: 'سال قبل',
        previous_decade: 'دههٔ قبل',
        ...
        calendar_cell_font_size_mode: 'اندازهٔ قلم در سلول تقویم',
        fit: 'تطبیقی',
        fixed: 'ثابت',
        reset: 'بازنشانی',
        scale: 'مقیاس',
        ...
        format_description:
          'فقط از تگ font استفاده کنید. در صورت استفاده از تگ جهت استایل‌دهی، حتما یک تگ دربرگیرنده داشته باشید و سپس داخل آن به صورت دلخواه از قالب و تگ‌ها استفاده کنید (نمونه‌ها را ببینید). شما می‌توانید با استفاده از تگ‌ها، قلم و رنگ را تغییر دهید. استایل‌های اعمال شده توسط تگ‌ها مقدم بر مقدارهای تنظیمات هستند. در حال حاضر قالب‌های زمان پشتیبانی نمی‌شوند.',
        font_size: 'اندازهٔ قلم',
