...
class World {
  constructor() {
    ...
    this.events[1][14] = ['روز جهانی منطق / جشن ولنتاین', false];
    ...
    this.events[3][20] = ['روز جهانی شادی / روز جهانی فرانکفونی', false];
    ...
    this.events[5][5] = ['روز جهانی ماما / روز میراث جهانی آفریقا / روز جهانی زبان پرتغالی', false];
    ...
    this.events[9][30] = ['روز جهانی دریانوردی / روز جهانی ناشنوایان / روز جهانی ترجمه و مترجم', false];
    ...
    this.events[10][10] = ['روز جهانی بهداشت روان / روز جهانی مبارزه با حکم اعدام', false];
    ...
    this.events[11][18] = ['روز جهانی هنر اسلامی / روز جهانی فلسفه', false];
